...
/// <summary>
/// Scales a selected view to fit within the current sheet.
/// </summary>
public class ScaleViewInSheetCommand : CommandBase<AppSettings> {
    public ScaleViewInSheetCommand(AddinUiManager uiMgr, ISwApplication swApp, AppSettings appSettings, AddIn addin)
    ...
    public void RunForCurrentDocument() {
        ...
        swModel.ScaleViewInSheetToMaxSize(sheet, selectedView);
        swModel.EditRebuild3();
        swModel.GraphicsRedraw2();
        swModel.Extension.SelectView(selectedView);
    }
} 