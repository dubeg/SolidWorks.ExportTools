...
public partial class SvgExporter(ISldWorks _app) {
    ...
    public List<string> Export(string filePath, bool fitToContent = false, bool includeBomMetadata = false, bool exportIndividualViews = false, string specificViewName = null, bool excludeViewsOutOfBounds = false) {
