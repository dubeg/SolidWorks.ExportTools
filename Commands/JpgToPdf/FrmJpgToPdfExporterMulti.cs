...
public partial class FrmJpgToPdfExporterMulti : Form {
    private readonly List<ExportFileItem> _items;
    private readonly Dictionary<ExportStatus, Image> _statusImages;
    private bool _exportInProgress;
    private bool _cancelRequested;

    private JpgToPdfCommand _controller { get; set; }
    private AppSettings _appSettings => _controller.AppSettings;

    public FrmJpgToPdfExporterMulti(JpgToPdfCommand controller) {
        InitializeComponent();
        Icon = Icon.FromHandle(Resources.jpg.GetHicon());
